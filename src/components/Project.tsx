...
const Project: React.FC = () => {
  ...
  const projects: ProjectItem[] = [
    {
       id: 1,
      title: "Hand Bag Melaniva",
      description:
        "Independently handled the entire production of the Melaniva handbag video, including concept development, lighting setup, filming, and video editing to highlight the product.",
      youtubeId: "GeY0LYZWg7g", // Thay bằng ID video YouTube của bạn
      link: "https://youtube.com/shorts/GeY0LYZWg7g?feature=share",
      thumbnailUrl: "https://img.youtube.com/vi/GeY0LYZWg7g/hqdefault.jpg",
    },
    {
       id: 2,
